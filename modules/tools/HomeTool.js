...
const CARDS = [
    ...
    { id: 'clock',           enabled: false, icon: 'fa-clock',             bg: 'bg-soft-purpleLight/30', fg: 'text-soft-purple',     title: 'Klockan',           desc: 'Dra i visarna för att jämföra analog och digital tid.' },
